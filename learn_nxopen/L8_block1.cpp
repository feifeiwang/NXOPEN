...
Data Members
UF_NULLSIGN = 0
create new target solid 创建新目标体

UF_POSITIVE = 1
add to target solid 求和

UF_NEGATIVE = 2
subtract from target solid 求差

UF_UNSIGNED = 3
intersect with target solid 求交

UF_NO_BOOLEAN = 4
feature has not been booleaned 功能尚未被布尔化
