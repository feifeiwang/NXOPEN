...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        /** TODO: Add a documentation comment describing this class.
            ...
            Such comments add no value for the customer. <br> To create a new instance of this class, use @link NXOpen::PDM::PdmSession::CreateSmartSaveBuilder  NXOpen::PDM::PdmSession::CreateSmartSaveBuilder @endlink  <br> 
