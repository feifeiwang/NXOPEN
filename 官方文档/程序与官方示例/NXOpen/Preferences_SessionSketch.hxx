        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SessionSketch
        {
            ...
            */
            ...
            /**Returns  the display auto dimensions preference 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayAutoDimensions
            (
            );
            /**Sets  the display auto dimensions preference 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
            ...
            /**Returns  the display sketch vertices toggle 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayVertices
            (
            );
            /**Sets  the display sketch vertices toggle 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
            ...
            /**Returns  the scale on first driving dimension option 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: bool ScaleOnFirstDrivingDimension
            (
            );
            /**Sets  the scale on first driving dimension option 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
