    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  AfuMathOperation
        {
            ...
            /** Calculate and store FastRMS Fitted PSD data from AFU Data Record  @return  Fast RMS output data @link CAE::AfuMathFastRMSOutput CAE::AfuMathFastRMSOutput@endlink  to be obtained 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            ...
            (
                ...
                int sourceRecordIndex /** Index of the source AFU Data Record */,
                NXOpen::CAE::AfuMathOperation::OutputType outputType /** Output type of new AFU Data Record */,
                const NXString & destinationAfuFileName /** Destination AFU file name. It is NULL if output_type is not @link CAE::AfuMathOperation::OutputTypeOtherFile CAE::AfuMathOperation::OutputTypeOtherFile@endlink .  */,
                NXOpen::CAE::AfuMathFastRMSInfo * fastRmsInfo /** Fast RMS information data @link CAE::AfuMathFastRMSInfo CAE::AfuMathFastRMSInfo@endlink  to be set */
            );
            /** Calculate and store FastRMS Fitted PSD data from AFU Data Record  @return  Fast RMS output data @link CAE::AfuMathFastRMSOutput CAE::AfuMathFastRMSOutput@endlink  to be obtained 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_ftk ("NX Advanced Graphing") */
            ...
            (
                ...
                int sourceRecordIndex /** Index of the source AFU Data Record */,
                NXOpen::CAE::AfuMathOperation::OutputType outputType /** Output type of new AFU Data Record */,
                const char * destinationAfuFileName /** Destination AFU file name. It is NULL if output_type is not @link CAE::AfuMathOperation::OutputTypeOtherFile CAE::AfuMathOperation::OutputTypeOtherFile@endlink .  */,
                NXOpen::CAE::AfuMathFastRMSInfo * fastRmsInfo /** Fast RMS information data @link CAE::AfuMathFastRMSInfo CAE::AfuMathFastRMSInfo@endlink  to be set */
            );
