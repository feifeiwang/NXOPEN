        ...
        */
        class NXOPENCPP_CAMEXPORT  DPMItpBuilder : public NXOpen::CAM::ParamBuilder
        {
            ...
            /**Returns  the  Cut Step Outol 
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::StepOutol NXOpen::CAM::DmStreamlineCutStep::StepOutol @endlink and @link NXOpen::CAM::DmStreamlineCutStep::SetStepOutol NXOpen::CAM::DmStreamlineCutStep::SetStepOutol @endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::StepOutol NXOpen::CAM::DmStreamlineCutStep::StepOutol @endlink and @link NXOpen::CAM::DmStreamlineCutStep::SetStepOutol NXOpen::CAM::DmStreamlineCutStep::SetStepOutol @endlink  instead.") NXOpen::CAM::InheritableDoubleBuilder * StepOuttol
            (
            );
            /**Returns  the  Cut Step Intol 
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::StepIntol NXOpen::CAM::DmStreamlineCutStep::StepIntol @endlink and @link NXOpen::CAM::DmStreamlineCutStep::SetStepIntol NXOpen::CAM::DmStreamlineCutStep::SetStepIntol @endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public:  NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::StepIntol NXOpen::CAM::DmStreamlineCutStep::StepIntol @endlink and @link NXOpen::CAM::DmStreamlineCutStep::SetStepIntol NXOpen::CAM::DmStreamlineCutStep::SetStepIntol @endlink  instead.") NXOpen::CAM::InheritableDoubleBuilder * StepIntol
            (
            );
