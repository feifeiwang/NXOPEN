        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DimensionPreferences : public NXOpen::TransientObject
        {
            ...
            /**Sets  the display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
             ...
             <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::Annotations::DimensionPreferences::SetSetLimitFitAssemblyNewDisplayStyle NXOpen::Annotations::DimensionPreferences::SetSetLimitFitAssemblyNewDisplayStyle@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public:  NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Annotations::DimensionPreferences::SetSetLimitFitAssemblyNewDisplayStyle instead.") void SetLimitFitAssemblyDisplayStyle
            (
