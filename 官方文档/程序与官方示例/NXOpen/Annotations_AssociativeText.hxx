        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  AssociativeText : public NXOpen::TransientObject
        {
            ...
            /** Returns the associative text for the input object and its property. 
                    ...
                    It is not the @link Drawings::DrawingSheet Drawings::DrawingSheet@endlink  itself, but rather the type is @link Annotations::AssociativeText::PropertyTypeDrawingSheetName Annotations::AssociativeText::PropertyTypeDrawingSheetName@endlink . <br> 
