    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSolutionBuilder : public NXOpen::Builder
        {
            ...
            /** Analysis type
                        The LMS Solver does not support @link NXOpen::Motion::MotionSolutionBuilder::AnalysisTypes::Control NXOpen::Motion::MotionSolutionBuilder::AnalysisTypes::Control@endlink .*/
