            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SubdivisionBridgeFaceBuilder : public NXOpen::Builder
            {
                ...
                /**Returns  the continuity. The continuity is used to specify creases in the limit surface corresponding to the outer
                                edges of the faces specified by @link NXOpen::Features::Subdivision::SubdivisionBridgeFaceBuilder::FaceSet1 NXOpen::Features::Subdivision::SubdivisionBridgeFaceBuilder::FaceSet1 @endlink and @link NXOpen::Features::Subdivision::SubdivisionBridgeFaceBuilder::SetFaceSet1 NXOpen::Features::Subdivision::SubdivisionBridgeFaceBuilder::SetFaceSet1 @endlink  and 
                                @link NXOpen::Features::Subdivision::SubdivisionBridgeFaceBuilder::FaceSet2 NXOpen::Features::Subdivision::SubdivisionBridgeFaceBuilder::FaceSet2 @endlink and @link NXOpen::Features::Subdivision::SubdivisionBridgeFaceBuilder::SetFaceSet2 NXOpen::Features::Subdivision::SubdivisionBridgeFaceBuilder::SetFaceSet2 @endlink . 
