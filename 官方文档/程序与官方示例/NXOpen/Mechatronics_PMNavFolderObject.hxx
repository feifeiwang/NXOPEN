...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        /** Represents the PMNav Folder object.  <br> Use @link NXOpen::Mechatronics::PhysicsManager::PMNavFolderObject NXOpen::Mechatronics::PhysicsManager::PMNavFolderObject @endlink and @link NXOpen::Mechatronics::PhysicsManager::SetPMNavFolderObject NXOpen::Mechatronics::PhysicsManager::SetPMNavFolderObject @endlink  to create  <br> 
