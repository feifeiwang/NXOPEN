            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SubdivisionExtrudeCageBuilder : public NXOpen::Builder
            {
                ...
                /**Returns  the continuity. The continuity is used to specify creases in the limit surface corresponding to the outer
                                edges of the faces or boundary edges specified by @link NXOpen::Features::Subdivision::SubdivisionExtrudeCageBuilder::SelectionObject NXOpen::Features::Subdivision::SubdivisionExtrudeCageBuilder::SelectionObject @endlink and @link NXOpen::Features::Subdivision::SubdivisionExtrudeCageBuilder::SetSelectionObject NXOpen::Features::Subdivision::SubdivisionExtrudeCageBuilder::SetSelectionObject @endlink . 
