...
namespace NXOpen
{
    ...
    namespace Layout2d
    {
        ...
        /** Represents a Builder for CreateComponentFrom3DBuilder functionality which will define <br> To create a new instance of this class, use @link NXOpen::Layout2d::ComponentCollection::CreateComponentFrom3dBuilder  NXOpen::Layout2d::ComponentCollection::CreateComponentFrom3dBuilder @endlink  <br> 
        Default values.
        <table border="1"> 
