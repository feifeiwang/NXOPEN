    ...
    namespace PID
    {
        ...
        */
        class PIDOPENCPPEXPORT  EquipmentBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the symbol ID of this equipment. It is only applicable when @link PID::EquipmentBuilder::SymbolSourceType PID::EquipmentBuilder::SymbolSourceType@endlink  is @link PID::SymbolSourceOptionReuseLibrary PID::SymbolSourceOptionReuseLibrary@endlink .
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_reader ("NX P and ID Design Reader") OR nx_pid_design_author ("NX P and ID Design Author") */
            public: NXString SymbolId
            (
            );
            /**Sets  the symbol ID of this equipment. It is only applicable when @link PID::EquipmentBuilder::SymbolSourceType PID::EquipmentBuilder::SymbolSourceType@endlink  is @link PID::SymbolSourceOptionReuseLibrary PID::SymbolSourceOptionReuseLibrary@endlink .
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /**Returns  the option to place a duplicate symbol. It is only applicable when @link PID::EquipmentBuilder::SymbolSourceType PID::EquipmentBuilder::SymbolSourceType@endlink  is @link PID::SymbolSourceOptionExistingSymbol PID::SymbolSourceOptionExistingSymbol@endlink .
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_reader ("NX P and ID Design Reader") OR nx_pid_design_author ("NX P and ID Design Author") */
            public: bool UseExistingID
            (
            );
            /**Sets  the option to place a duplicate symbol. It is only applicable when @link PID::EquipmentBuilder::SymbolSourceType PID::EquipmentBuilder::SymbolSourceType@endlink  is @link PID::SymbolSourceOptionExistingSymbol PID::SymbolSourceOptionExistingSymbol@endlink .
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
