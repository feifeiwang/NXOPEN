...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  STLCreator : public NXOpen::Builder
    {
        ...
        /**Returns  the triangle tol - tolerance for triangle 
         <br>  Created in NX11.0.0.  <br>  
         <br> License requirements : None */
        public: double TriangleTol
        (
        );
        /**Sets  the triangle tol - tolerance for triangle 
         <br>  Created in NX11.0.0.  <br>  
         <br> License requirements : None */
        public: void SetTriangleTol
        (
            double triangleTol /** triangletol */ 
        );
